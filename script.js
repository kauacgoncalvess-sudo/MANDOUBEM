...
document.querySelectorAll('.avatarOption').forEach(b=>{

  b.onclick=()=>{

    document
      .querySelectorAll('.avatarOption')
  ...
  <article class="card">
    ...
    <div class="cardbody">
      ...
      <div class="foot">
        ...
        <span class="points">● ${x.points}</span>

        <button
          class="open"
          onclick="detail('${x.name}')">
          Ver loja
        </button>
  ...
  $('#rewards').innerHTML=
    ...
    rewards.map((r,i)=>`
      ...
      <article class="reward">
        ...
        <p>
          ${r[2]}<br>
          Benefício demonstrativo do protótipo.
        </p>
    ...
    islands.map((x,i)=>{
      ...
      return `
        ...
        <div class="island
          ...
          <div class="islandBubble">

            ${x.emoji}

            ${
              current
              ? `<span class="islandAvatar">
          ...
          <div class="islandLabel">
            ...
            <small>
              ${
                x.points===0
                ? 'Início'
                : x.points.toLocaleString('pt-BR')+' pontos'
              }
            </small>

          </div>

          <span class="islandBadge">

            ${
              unlocked
              ? (current?'VOCÊ ESTÁ AQUI':'DESBLOQUEADA')
              : '🔒 BLOQUEADA'
            }
...
function updateJourney(){
  ...
  $('#nextIsland').textContent=
    next
    ? (next-pts).toLocaleString('pt-BR')
    : '0';


  $('#islandsUnlocked').textContent=
  ...
  $('#detail').innerHTML=`
    ...
    <div class="detail">
      ...
      <div class="detailbody">
        ...
        <p>
          Faça sua compra neste estabelecimento
          e os pontos serão registrados na sua
          conta MANDOU BEM.
        </p>

        <button
          class="open"
          onclick="toast('Nesta etapa, aqui entrará o catálogo do estabelecimento.')">
